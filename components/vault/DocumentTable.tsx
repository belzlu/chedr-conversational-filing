  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Document Count */}
        <span className="ml-auto text-hig-caption2 text-white/70">
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
      <div className="w-16 h-16 rounded-full bg-white/[0.06] flex items-center justify-center mb-4">
        <IconFile className="w-8 h-8 text-white/60" />
      </div>
      <h3 className="text-hig-body font-medium text-white mb-2">
        {message.title}
      </h3>
      <p className="text-hig-caption2 text-white/60 max-w-xs">
        {message.description}
      </p>
    </div>
  );
